...
This selective inclusion also allows us to ignore irrelevant or non-contributory operations, such as spin loops in multithreaded libraries~\cite{looppoint}, that do not meaningfully impact program progress.
