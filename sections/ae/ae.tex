...
The only external benchmark suites required are NAS Parallel Benchmarks (NPB) and LSMS, included or fetched by the artifact. All other data (interval analysis CSVs, measurement CSVs, prediction-error CSVs) are generated by the scripts from the code itself and from NPB runs.
