...
\begin{enumerate}
    ...
    \item Quickly validate the selected samples for the targeted benchmarks and input size.
\end{enumerate}
...
We then address the second and third goal by employing two simple sample selection methodologies, random sampling and LLVM IR basic block (IRBB) vector-based k-means sampling, and evaluating their effectiveness (Section~\ref{sec:sampling_methodology_validation}).
