...
We use the ``-O2'' optimization level for the compilation.
...
We used SPEC~CPU2017 Integer suite, except for ``619.lbm\_s'' and ``644.nab\_s'', which are from the Floating-Point suite.
