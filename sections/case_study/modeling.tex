...
We found the data cache statistics explained most of the runtime error and for more than 97\% of the nuggets, the error in the number of accesses to the data cache could be explained by differences in the number of memory instructions.
...
We observed that the nugget with the largest error was dominated by \revision{Arm's} paired memory instructions (e.g., ldp, stp), while fewer were present in samples with small error.
