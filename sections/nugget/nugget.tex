...
It is not the focus of this paper to introduce a new sample selection algorithm, but rather to provide a framework that can be used to implement and validate diverse sample selection methodologies that can be tailored to specific applications and workloads.
...
\begin{figure}[!t]
    ...
    The preparation and analysis stage, including base IR file creation and interval analysis execution, only needs to be performed once per program.
