...
Therefore, we can validate the selected samples on real hardware, and use them for simulation.
...
In the future, we plan to reduce this overhead further by exploring techniques such as creating software checkpoints using CRIU~\cite{CRIU} or BLCR~\cite{BLCR} to resume execution closer to the sample start point.
