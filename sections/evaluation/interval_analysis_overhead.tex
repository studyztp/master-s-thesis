...
(1) \textit{low slowdown}, quantified as the ratio between the time spent on interval analysis and the time required for executing the full workload; and
(2) \textit{flexibility}, meaning the ability to perform the analysis across different host machines.
