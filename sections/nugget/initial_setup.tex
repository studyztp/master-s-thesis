...
While build-time modes such as LTO and PGO can alter LLVM IR, they are disabled by default.
For our experiments, the LLVM IR structure remained stable across optimization levels, CPU-feature flags, and LLVM versions.
