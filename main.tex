...
We evaluate Nugget with SPEC~CPU2017, NPB, and LSMS workloads on AMD Ryzen and Ampere Altra hardware, demonstrating $54\times$ average overhead for multi-threaded and $3\times$ for single-threaded workloads---a $577\times$ reduction over functional simulation.
